...
{
    private ICommandStart starttable;

    public StartCommand(ICommandStart starttable)
    {
        this.starttable = starttable;
    }
    public void Execute()
    {
        starttable.Properties.ToList().ForEach(a => IoC.Resolve<ICommand>("Game.Property.Set", starttable.Target, a.Key, a.Value).Execute());
